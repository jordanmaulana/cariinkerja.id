"""Crawl a Glints Indonesia listing URL and persist Job rows.

Example:

    uv run manage.py crawl_glints \\
...
from jobs.scrapers import glints

logger = logging.getLogger(__name__)


class Command(BaseCommand):
    help = "Crawl a Glints listing URL and upsert Job rows by url."
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            ...
            help=(
                "Glints explore URL "
                "(e.g. https://glints.com/id/opportunities/jobs/explore?keyword=flutter&country=ID)"
            ),
        )
        parser.add_argument("--max-pages", type=int, default=1)
        parser.add_argument("--sleep", type=float, default=glints.DEFAULT_SLEEP)
